public class Sorter{
	...
	String[] names = {"Ardelia Ashcroft","Byron Buttner","Jacquelyne Johnson","Tory Torrens","Gordon
Gaillard","Aurea Ahlers","Tamiko Torrey","Latoya Ledoux","Hai Hudman","Lauren Lenox"};
double[] hourly = {37.65,94.09,56.52,61.60,52.00,39.76,10.40,23.56,24.83,45.74};
	
	public static void main(String[] args){
		
		Sorter ourObj = new SortedSalaries();
